...
public enum ServerMessage {
	...
	ADD_AUTHOR("add_author"), //TODO
	ADD_BOOK("add_book"),
	ADD_USER("add_user"),
	ADD_USER_BOOK("add_user_book"),
	DELETE_AUTHOR("delete_author"), //TODO
	DELETE_BOOK("delete_book"),
	DELETE_USER_BOOK("delete_user_book"),
	GET_ALL_BOOKS("show_allbooks"),
	GET_ALL_AUTHORS("get_all_authors"), //TODO
	LOGIN_CHECK("login_check"),
	SEARCH_BOOK("search"), 
	SEARCH_BOOKS("search_books"),
	SHOW_AUTHORS_BOOKS("show_authors_books"), //TODO
	SHOW_BOOKS("show_books"),
	UPDATE_AUTHOR("update_author"), //TODO
